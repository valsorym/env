...
func TestGetInt64(t *testing.T) {
	...
	_, err = getInt64("string")
	if err == nil {
		t.Error("getInt64: didn't handle the error")
	}

	// Parse empty string.
	v, err = getInt64("")
	if err != nil {
		t.Error("getInt64: to raise an exception on an empty string")
	}

	if v != 0 {
		t.Error("getInt64: has an invalid default value")
	}
	...
	if v != 3 {
		t.Errorf("getInt64: incorrect value: `%d`!=3", v)
	}

	// Parse to long value.
	_, err = getInt64("922337203685477580777")
	if err == nil {
		t.Error("getInt64: the `value out of range` error was ignored")
	}

}

// TestGetUint64 tests getUint64 function.
func TestGetUint64(t *testing.T) {
	...
	v, err = getUint64("")
	if err != nil {
		t.Error("to raise an exception on an empty string")
	}

	if v != 0 {
		t.Error("has an invalid default value")
	}
	...
	if v != 3 {
		t.Errorf("incorrect value: `%d`!=3", v)
	}

	// Parse to long value.
	_, err = getUint64("922337203685477580777")
	if err == nil {
		t.Error("the `value out of range` error was ignored")
	}

}

// TestGetFloat64 tests getFloat64 function.
func TestGetFloat64(t *testing.T) {
	...
	// Parse correct value.
	v, err = getFloat64("3.0")
	if err != nil {
		t.Errorf("%v", err)
	}

	if v != 3.0 {
		t.Errorf("incorrect value: `%f`!=3.0", v)
	}
}
